...
// ============================================================
//  ESP32 + W5500 — OTS Side (Lift 5 & 6) + Temperature
...
// ╚══════════════════════════════════════════════════════════════╝
#define STATIC_IP 192, 168, 1, 103
...
#define NODE_TAG "node3"
#define NODE_NAME "OTS"
#define LIFT_A_NAME "lift5"
#define LIFT_B_NAME "lift6"
#define AP_NAME "OTS-Lift-Node-Wifi-Setting"
...
void sendHeartbeat() {
  ...
  if (Ethernet.linkStatus() == LinkON) {
    if (connMode == MODE_ETHERNET || connMode == MODE_DUAL) {
  ...
  } else if (connMode == MODE_DUAL && WiFi.status() == WL_CONNECTED) {
    Serial.print(F("CONNECTED (hot standby) IP: "));
    Serial.println(WiFi.localIP());
  } else if (connMode == MODE_WIFI_CONNECTING || wifiStandbyActive) {
...
WiFiManagerParameter portalInfo(
  "<p><b>Lift Alarm Node OTS - WiFi Setup</b><br>"
...
void startWifiConfigPortal() {
  ...
  wm.setTitle("Lift Alarm Node - OTS");
  wm.setClass("invert");
